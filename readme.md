...
> **Note**：資料截至 2026-04-25（articles 累計 177,973 筆，pipeline 持續補爬中）。`/sentiments/today` 若當日無資料會回 404（`{"message":"No data for today"}`）而非 500，查看已存在日期請用 `/sentiments/recent?period=30`。
