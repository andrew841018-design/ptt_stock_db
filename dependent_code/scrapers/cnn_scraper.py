...
使用 CNN 官方 Google News sitemap 直接取得文章列表，再抓取全文。
...
_SITEMAP_URL = "https://edition.cnn.com/sitemap/news.xml"
...
class CnnScraper(BaseScraper):
    ...
    def _fetch_sitemap(self) -> list:
        try:
            ...
            logging.warning("CNN sitemap 解析失敗：%s", e)
            return []
